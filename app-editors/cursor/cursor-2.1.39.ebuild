...
SRC_URI="https://downloads.cursor.com/production/60d42bed27e5775c43ec0428d8c653c49e58e26a/linux/x64/deb/amd64/deb/cursor_2.1.39_amd64.deb -> ${P}.deb"
...
src_prepare() {
	...
	# Mark bundled Node.js binaries and native modules as executable
	# This is critical for AI agent functionality (ripgrep, pty, etc.)
	find usr/share/cursor/resources/app/node_modules -type f \( -path "*/bin/*" -o -name "*.node" \) -exec chmod 755 {} + || true
}
...
src_install() {
	...
	# Ensure all Node.js native binaries remain executable in installed location
	# Without this, the AI agent cannot spawn ripgrep or use native modules
